...
MainMenu = require('modules.menu')

local clientevt = require('modules.client')
local globalevt = require('modules.global')

local modkey = globalevt.modkey
...
root.buttons(gears.table.join(
	awful.button({ }, 1, function () MainMenu.menu:hide() end),
...
for i = 1, 9 do
    globalevt.keys = gears.table.join(globalevt.keys,
        -- View tag only.
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     raise = true,
                     keys = clientevt.clientkeys,
                     buttons = clientevt.clientbuttons,
